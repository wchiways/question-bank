  ...
  const fastapiFeatures = [
    {
      ...
      title: '高性能异步',
      description: '基于 Starlette 和 Pydantic，提供原生异步支持，处理并发请求性能优异'
    },
    {
      icon: <CodeOutlined style={{ fontSize: 28, color: '#1890ff' }} />,
      title: '自动文档生成',
      description: 'Swagger UI 和 ReDoc 自动生成，无需手动编写 API 文档，开箱即用'
    },
    {
    ...
    },
    {
      ...
      title: '模块化设计',
      description: '清晰的目录结构，Repository 模式分离数据访问层，易于维护和扩展'
    },
    {
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 80 }}>
          ...
          <p style={{
            ...
            全链路异步处理支持高并发，相比 Flask 版本性能提升 50 倍。
            支持多 AI 平台智能答题，自动生成 API 文档，开箱即用。
          </p>
          <Space size="large">
              ...
              <Col xs={24} sm={12} lg={8} key={index}>
                ...
                >
                  <Space direction="vertical" size="middle" style={{ width: '100%' }}>
                    ...
                    <div>
                      <h3 style={{ marginBottom: 12, color: '#262626', fontSize: 18, fontWeight: 600, marginTop: 0 }}>
                        {feature.title}
                      </h3>
        ...
        <div style={{ marginBottom: 80 }}>
          <Card style={{
            ...
            <Space direction="vertical" size="large" style={{ width: '100%' }} align="center">
              <h3 style={{ margin: 0, color: '#262626', fontSize: 24, fontWeight: 600, marginTop: 0 }}>
                技术栈
              </h3>
            ...
            <Space direction="vertical" size="large" style={{ width: '100%' }}>
              <div style={{ textAlign: 'center', marginBottom: 32 }}>
                ...
                <p style={{
                  ...
                  采用现代化 Python Web 框架，构建高性能、类型安全的 RESTful API 服务
                </p>
              </div>
              ...
              <div style={{
                ...
                <Space direction="vertical" size="small" style={{ width: '100%' }}>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, marginTop: 8 }}>
                    <Tag color="blue" style={{ fontSize: 14, padding: '6px 14px', borderRadius: 4 }}>
                      Python 3.11+
                    </Tag>
                    <Tag color="teal" style={{ fontSize: 14, padding: '6px 14px', borderRadius: 4 }}>
                      FastAPI 0.127+
                    </Tag>
                    <Tag color="orange" style={{ fontSize: 14, padding: '6px 14px', borderRadius: 4 }}>
                      SQLModel
                    </Tag>
                    <Tag color="green" style={{ fontSize: 14, padding: '6px 14px', borderRadius: 4 }}>
                      aiosqlite
                    </Tag>
                    <Tag color="purple" style={{ fontSize: 14, padding: '6px 14px', borderRadius: 4 }}>
                      httpx
                    </Tag>
                    <Tag color="cyan" style={{ fontSize: 14, padding: '6px 14px', borderRadius: 4 }}>
                      loguru
                    </Tag>
                    <Tag color="red" style={{ fontSize: 14, padding: '6px 14px', borderRadius: 4 }}>
                      uv
                    </Tag>
                  </div>
                </Space>
        ...
        <div style={{ marginBottom: 80 }}>
          <h2 style={{
            ...
            <ThunderboltOutlined style={{ marginRight: 12, color: '#f5222d' }} />
            性能对比
          </h2>
          <Card
            style={{
          ...
          >
            <Row gutter={[32, 32]}>
              <Col xs={24} md={8}>
                ...
                >
                  <Space direction="vertical" size="middle" style={{ width: '100%' }}>
                    <div style={{ fontSize: 48, fontWeight: 700, color: '#52c41a' }}>
                      50x
                    </div>
                    <h3 style={{
                      fontSize: 18,
              ...
              <Col xs={24} md={8}>
                ...
                >
                  <Space direction="vertical" size="middle" style={{ width: '100%' }}>
                    <div style={{ fontSize: 48, fontWeight: 700, color: '#1890ff' }}>
                      2x
                    </div>
                    <h3 style={{
                      fontSize: 18,
                ...
                <Link href={link.href}>
                  ...
                  >
                    <Space direction="vertical" size="middle" style={{ width: '100%' }}>
                      ...
                      <h3 style={{ margin: 0, color: '#262626', fontSize: 18, fontWeight: 600, marginTop: 0 }}>
                        {link.title}
                      </h3>
        ...
        <Card style={{
          ...
          <Space direction="vertical" size="large" style={{ width: '100%' }}>
            <h3 style={{ color: '#fff', margin: 0, fontSize: 24, fontWeight: 600, marginTop: 0 }}>
              准备好了吗？
            </h3>
            ...
            <div>
              <CheckCircleOutlined style={{ fontSize: 32, color: '#fff', marginRight: 16 }} />
              <CheckCircleOutlined style={{ fontSize: 32, color: '#fff', marginRight: 16 }} />
          ...
          <Row gutter={[32, 32]}>
            <Col xs={24} md={12}>
              <Space direction="vertical" size="small" style={{ width: '100%' }}>
                ...
                <div>
                  <p style={{ fontSize: 16, fontWeight: 600, color: '#262626', margin: '0 0 8px 0' }}>
                    Chiway Wang
                  </p>
                  <Space direction="vertical" size="small">
                    <a
                      href="mailto:wchiway@163.com"
                      style={{ color: '#1890ff', textDecoration: 'none', fontSize: 14 }}
                    >
                      📧 wchiway@163.com
                    </a>
                    <a
            ...
            <Col xs={24} md={12}>
              <Space direction="vertical" size="small" style={{ width: '100%' }}>
                ...
                <p style={{ fontSize: 14, color: '#8c8c8c', margin: 0, lineHeight: '1.8' }}>
                  感谢以下开源项目的支持：
                </p>
                ...
                <p style={{ fontSize: 14, color: '#8c8c8c', margin: '8px 0 0 0' }}>
