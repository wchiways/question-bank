...
export default function ConfigPage() {
  ...
  return (
    <PageContainer>
      ...
      >
        <ProCard title="应用配置" headerBordered collapsible style={{ marginBottom: 16 }}>
          <ProForm.Group>
        ...
        <ProCard title="服务器配置" headerBordered collapsible style={{ marginBottom: 16 }}>
          <ProForm.Group>
        ...
        <ProCard title="AI 配置" headerBordered collapsible style={{ marginBottom: 16 }}>
          <ProForm.Group>
        ...
        <ProCard title="限流配置" headerBordered collapsible style={{ marginBottom: 16 }}>
          <ProForm.Group>
            <ProFormSwitch name={['rate_limit', 'enabled']} label="启用限流" />
            <ProFormDigit name={['rate_limit', 'per_minute']} label="每分钟限额" />
          </ProForm.Group>
        </ProCard>
      </ProForm>
    </PageContainer>
